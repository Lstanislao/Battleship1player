...
def jugar (tabla):
    ...
    print(Fore.YELLOW+'IMPORTANTE: el tablero sobre el que disparara es el de color rojo,en cual el enemigo posiciono sus barcos y este le dispara a usted sobre el tablero azul donde usted posiciono sus barcos ')
    ...
    while hundido!=9 or hundidoComputadora!=9:
